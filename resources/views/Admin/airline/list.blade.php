...
<div class="flex justify-between items-center">
    ...
    <div class="flex items-center gap-3">
      <a href="{{ route('admin.airline.create') }}" class="flex items-center gap-2 px-4 py-2 bg-black text-white rounded-md">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
    <div class="bg-white border p-5 rounded-lg">
      <p class="text-sm text-gray-500">All AirLine</p>
    ...
    <table class="min-w-full text-left text-sm">
      ...
      <tbody>
        ...
        <tr class="border-b">
          ...
          <td class="p-3">Pakistan Air Line</td>
          <td class="p-3">PIA</td>
